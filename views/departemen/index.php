...
<div id="modalForm" class="modal" style="display: <?= $showModal ? 'flex' : 'none' ?>;">
    <div class="modal-content">
        <div class="modal-header">
            <h3><?= $showEditModal ? '<i class="fas fa-edit"></i> Edit Departemen' : '<i class="fas fa-plus-circle"></i> Tambah Departemen' ?></h3>
...
<div id="confirmModal" class="modal" style="display: none;">
    <div class="modal-content" style="width: 350px;">
        ...
        <p style="color: #bdc3c7; margin: 20px 0;">Apakah Anda yakin ingin menghapus departemen ini? Data yang dihapus tidak dapat dipulihkan.</p>
        <div class="modal-footer">
